...
class AccountCreditDetailAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return AccountCreditDetailViewHolder(view)
    }

    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        val item = trans[position]
        val viewHolder = holder as AccountCreditDetailAdapter.AccountCreditDetailViewHolder
...
*/
    ...
    inner class AccountCreditDetailViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
