...
import com.example.ngiu.databinding.FragmentAccountListBinding
import com.example.ngiu.functions.EDIT_MODE
import com.example.ngiu.functions.KEY_ACCOUNT_LIST
import com.example.ngiu.functions.KEY_ACCOUNT_LIST_CATEGORY_ID
import com.example.ngiu.functions.KEY_ACCOUNT_LIST_EXCEPT_ID
import com.example.ngiu.functions.KEY_ACCOUNT_LIST_MODE
import com.example.ngiu.functions.KEY_ACCOUNT_LIST_PAY_ID
import com.example.ngiu.functions.KEY_ACCOUNT_LIST_RECEIVE_ID
import com.example.ngiu.functions.KEY_ACCOUNT_LIST_TRANSACTION_TYPE_ID
import com.example.ngiu.functions.KEY_RECORD_ACCOUNT_LIST
import com.example.ngiu.functions.KEY_RECORD_CATEGORY
import com.example.ngiu.functions.KEY_RECORD_CATEGORY_ID
import com.example.ngiu.functions.KEY_RECORD_PAY_ACCOUNT_ID
import com.example.ngiu.functions.KEY_RECORD_PAY_ACCOUNT_NAME
import com.example.ngiu.functions.KEY_RECORD_RECEIVE_ACCOUNT_ID
...
class AccountListFragment : Fragment(){
    ...
    private fun backToRecordFragment(acctName: String ="", payAccount: Boolean = true){
        // pass the string back to record fragment
        setFragmentResult(KEY_RECORD_ACCOUNT_LIST, bundleOf(
