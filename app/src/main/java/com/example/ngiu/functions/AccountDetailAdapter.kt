...
import kotlinx.android.synthetic.main.account_detail_cardview.view.*


class AccountDetailAdapter(private val person: MutableList<Person>)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view: View = LayoutInflater.from(parent.context)
            .inflate(R.layout.account_detail_cardview,parent,false)
