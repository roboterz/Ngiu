...
// KEY VALUE
const val ACCOUNT_ADD_CASH = 1
const val ACCOUNT_ADD_CREDIT = 2
const val ACCOUNT_ADD_DEBIT = 3
const val ACCOUNT_ADD_INVESTMENT = 4
const val ACCOUNT_ADD_WEB = 5
const val ACCOUNT_ADD_VALUE_CARD = 6
const val ACCOUNT_ADD_VIRTUAL = 7
const val ACCOUNT_ADD_ASSETS = 8
const val ACCOUNT_ADD_PAYABLE = 9

const val ACCOUNT_EDIT_CASH = 21
const val ACCOUNT_EDIT_CREDIT = 22
const val ACCOUNT_EDIT_DEBIT = 23
const val ACCOUNT_EDIT_INVESTMENT = 24
const val ACCOUNT_EDIT_WEB = 25
const val ACCOUNT_EDIT_VALUE_CARD = 26
const val ACCOUNT_EDIT_VIRTUAL = 27
const val ACCOUNT_EDIT_ASSETS = 28
const val ACCOUNT_EDIT_PAYABLE = 29
