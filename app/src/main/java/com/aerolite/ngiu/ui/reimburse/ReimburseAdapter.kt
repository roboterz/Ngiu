...
class ReimburseAdapter(
    private val onClickListener: OnClickListener
)
    : RecyclerView.Adapter<ReimburseAdapter.ViewHolder>() {
    ...
    interface OnClickListener {
        ...
        fun onItemSelect(transID: Long, selected: Boolean)
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        listDetail[position].apply {
            ...
            // checkbox
            holder.recordCheckBox.visibility = View.VISIBLE
            holder.recordCheckBox.isChecked = Transaction_ReimburseStatus == REIMBURSED
...
//            holder.recordCheckBox.setOnClickListener{
//                it.isSelected = !it.isSelected
//                onClickListener.onItemSelect(Transaction_ID, it.isSelected)
//            }
            holder.recordCheckBox.setOnCheckedChangeListener { buttonView, isChecked ->
                onClickListener.onItemSelect(Transaction_ID, isChecked)
            }
        }
    }
